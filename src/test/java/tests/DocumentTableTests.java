...
public class DocumentTableTests extends TestBase {
    ...
    @Description("Document table null test")
    @Test(dataProvider = "validNullDoc", dataProviderClass = DataProviderDocument.class, alwaysRun = true)
    public void testTableNullInBody(EntityRequest dataProvider) throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException {
