...
public class ExceptionSimpleEntityModel extends ExceptionModel {
    ...
    public ExceptionSimpleEntityModel withCode(int code) {
        this.code = code;
        return this;
    }

    public ExceptionSimpleEntityModel withDescription(String description) {
    ...
    public boolean equals(Object o) {
        ...
        ExceptionSimpleEntityModel regularSimpleEntityModel = (ExceptionSimpleEntityModel) o;
