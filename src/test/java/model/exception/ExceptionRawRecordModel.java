...
public class ExceptionRawRecordModel extends ExceptionModel {
    ...
    public ExceptionRawRecordModel withCode(int code) {
        this.code = code;
        return this;
    }

    public ExceptionRawRecordModel withDescription(String description) {
    ...
    public boolean equals(Object o) {
        ...
        ExceptionRawRecordModel regularRawRecordModel = (ExceptionRawRecordModel) o;
