...
abstract public class ExceptionModel implements BaseModel {
    ...
    public ExceptionModel withCode(int code) {
        this.code = code;
        return this;
    }

    public ExceptionModel withCodeText(String codeText) {
    ...
    public ExceptionModel withMessageToLog(String messageToLog) {
    ...
    public ExceptionModel processAccept() {
    ...
    public ExceptionModel processContent() {
