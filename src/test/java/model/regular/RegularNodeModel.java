...
public class RegularNodeModel extends RegularModel {
    ...
    public RegularNodeModel withCode(int code) {
        this.code = code;
        return this;
    }

    public RegularNodeModel withDescription(String description) {
    ...
    public boolean equals(Object o) {
        ...
        RegularNodeModel regularNodeModel = (RegularNodeModel) o;
