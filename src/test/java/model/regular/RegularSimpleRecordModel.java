...
public class RegularSimpleRecordModel extends RegularModel {
    ...
    public RegularSimpleRecordModel withCode(int code) {
        this.code = code;
        return this;
    }

    public RegularSimpleRecordModel withDescription(String description) {
    ...
    public boolean equals(Object o) {
        ...
        RegularSimpleRecordModel regularSimpleRecordModel = (RegularSimpleRecordModel) o;
