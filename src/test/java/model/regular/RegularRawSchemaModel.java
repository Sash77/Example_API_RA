...
public class RegularRawSchemaModel extends RegularModel {
    ...
    public RegularRawSchemaModel withCode(int code) {
        this.code = code;
        return this;
    }

    public RegularRawSchemaModel withCodeText(String codeText) {
    ...
    public boolean equals(Object o) {
        ...
        RegularRawSchemaModel regularSimpleSchemaModel = (RegularRawSchemaModel) o;
